...
.. raw:: html
   ...
   <form id="badgeform" class="pure-form">
     <fieldset> 
         <input type="text" id="lefttext" placeholder="launch">
         <input type="text" id="righttext" placeholder="binder">
         <input type="text" id="urltext" placeholder="mybinder.org/v2/gh/mypath">
         <br />

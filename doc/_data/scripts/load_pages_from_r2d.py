...
source_root = (
    "https://raw.githubusercontent.com/jupyter/repo2docker/master/docs/source/"
)
file_mappings = {
...
for source, dest in file_mappings.items():
    ...
    if not path_dest.exists():
        print(
            f"repo2docker page does not exist, downloading from repo2docker docs. {source}"
        )
        ...
        print(
            f"repo2docker page exists, skipping download. Delete it to re-download. {source} "
        )
